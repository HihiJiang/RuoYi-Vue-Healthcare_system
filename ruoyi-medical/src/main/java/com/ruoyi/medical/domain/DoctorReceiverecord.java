 ...
 * @date 2024-06-11
 */
public class DoctorReceiverecord extends BaseEntity
{
    ...
    public void setRecordsDeptid(Long recordsDeptid) 
    {
        this.recordsDeptid = recordsDeptid;
    }

    public Long getRecordsDeptid() 
    {
        return recordsDeptid;
    }
    public void setRecordsNo(Long recordsNo) 
    {
        this.recordsNo = recordsNo;
    }

    public Long getRecordsNo() 
    {
        return recordsNo;
    }
