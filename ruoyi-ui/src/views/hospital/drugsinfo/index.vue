  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="规格" prop="drugsSize">
        <el-select v-model="queryParams.drugsSize" placeholder="请选择规格" clearable>
          <el-option
            v-for="dict in dict.type.drugs_size"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="药品状态" prop="drugsStatus">
        <el-select v-model="queryParams.drugsStatus" placeholder="请选择药品状态" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['hospital:drugsinfo:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['hospital:drugsinfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['hospital:drugsinfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['hospital:drugsinfo:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="drugsinfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="规格" align="center" prop="drugsSize">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.drugs_size" :value="scope.row.drugsSize"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="药品状态" align="center" prop="drugsStatus">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="规格" prop="drugsSize">
          <el-select v-model="form.drugsSize" placeholder="请选择规格">
            <el-option
              v-for="dict in dict.type.drugs_size"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="药品状态" prop="drugsStatus">
          <el-select v-model="form.drugsStatus" placeholder="请选择药品状态">
            <el-option
              v-for="dict in dict.type.drugs_status"
              :key="dict.value"
              :label="dict.label"
...
<script>
import { listDrugsinfo, getDrugsinfo, delDrugsinfo, addDrugsinfo, updateDrugsinfo } from "@/api/hospital/drugsinfo";

export default {
  name: "Drugsinfo",
  dicts: ['drugs_size', 'drugs_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('hospital/drugsinfo/export', {
        ...this.queryParams
