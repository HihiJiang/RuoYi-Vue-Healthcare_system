<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="库存数量" prop="storageNo">
        <el-input
      ...
      <el-form-item label="更新时间" prop="storageUpdatetime">
        <el-date-picker clearable
          v-model="queryParams.storageUpdatetime"
          type="date"
    ...
    <el-table v-loading="loading" :data="storageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="库存数量" align="center" prop="storageNo" />
      <!-- <el-table-column label="更新时间" align="center" prop="storageUpdatetime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.storageUpdatetime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="库存数量" prop="storageNo">
          <el-input v-model="form.storageNo" placeholder="请输入库存数量" />
        </el-form-item>
        <el-form-item label="药品ID" prop="drugsId">
        ...
        <el-form-item label="更新时间" prop="storageUpdatetime">
          <el-date-picker clearable
            v-model="form.storageUpdatetime"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="请选择更新时间">
          </el-date-picker>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除药库库存编号为"' + storageIds + '"的数据项？').then(function() {
